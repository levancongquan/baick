...
public final class UpdatePopBinding implements ViewBinding {
  ...
  private UpdatePopBinding(@NonNull LinearLayout rootView, @NonNull Button btnTrove,
      @NonNull AppCompatButton btnUpdate, @NonNull EditText edtGiamonan,
      @NonNull EditText edtLinkanh, @NonNull EditText edtMotamonan, @NonNull EditText edtTenmonan) {
  ...
  public static UpdatePopBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new UpdatePopBinding((LinearLayout) rootView, btnTrove, btnUpdate, edtGiamonan,
